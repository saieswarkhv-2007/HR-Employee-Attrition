...
# HR EMPLOYEE ATTRITION PREDICTION USING RAW DATASET
# ================================================================
#
# IMPORTANT:
...
# Fallback to final_preprocess.csv if raw not found
...
OUTPUT_FOLDER = os.path.join(
    BASE_DIR,
    "outputs",
    "Decision_Tree_Classifier_Outputs"
)
...
print("=" * 80)
print(
    " DECISION TREE HR EMPLOYEE ATTRITION PREDICTION"
)
print("=" * 80)
...
# ================================================================
# 16. REMOVE COMPLETELY EMPTY OR SINGLE-VALUE FEATURES
# ================================================================
...
plt.title(
    "Decision Tree Performance - HR Employee Attrition"
)
plt.xlabel(
    "Evaluation Metric"
)
...
# ================================================================
# 48. SAVE DECISION TREE PARAMETERS
# ================================================================
