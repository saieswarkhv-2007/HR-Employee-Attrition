...
print("=" * 80)
print(
    " RANDOM FOREST HR EMPLOYEE ATTRITION PREDICTION"
)
print("=" * 80)
...
plt.title(
    "Random Forest Performance - HR Employee Attrition"
)
plt.xlabel(
    "Metrics"
)
...
plt.title(
    "Random Forest - Tree 1 (HR Employee Attrition)",
    fontsize=20
)
plt.tight_layout()

# ================================================================
# 45. SAVE RANDOM FOREST TREE
# ================================================================
