...
print("=" * 80)
print(
    " ADABOOST HR EMPLOYEE ATTRITION PREDICTION"
)
print("=" * 80)
...
plt.title(
    "AdaBoost Performance - HR Employee Attrition"
)
plt.xlabel(
    "Evaluation Metric"
)
...
plt.title(
    "Actual vs Predicted Attrition - AdaBoost"
)
...
plt.title(
    "AdaBoost - First Base Decision Tree (HR Employee Attrition)",
    fontsize=20
)
plt.tight_layout()
